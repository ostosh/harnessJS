(function(harness) {
  ...
  *
  * @param {!document.documentElement} subjectDom The application root DOM node to be used for purposes of testing.
  */
  Subject.prototype.usingUri = function( uri ) {
    if(!uri)
  ...
  */
  ...
  /**
  * Bind readyState event handlers a newly created sestSubject instance.
  * 
  ...
  *
  * @param {string} nameSpace The name of a name space object at subject application's global scope.
  ...
  */
  ...
  /**
  * Blocks execution until Subject instance's ready state is true or optional promise returns true.
  *
  * @param {function} func Optional callback to be executed when blocking condition is resolved.
  * @param {function} promise Optional polling function that will override the Subject instance's ready state.
  *        Function must eventually resolve to true.
  * @return {Object} Return value of the optional callback given. Otherwise, the estSubject instance's ready state.
  */
  ...
  *
  * @param {function} func Callback to be executed when instance's ready state is true.
  ...
  */
  Builder.prototype.usingResource = function(uri) {
    if( typeof this.uri_ !== 'string' || !builderUtils.resourceExists( uri ) )
  ...
  /**
  * Sets the style of a subject application's root container documentElement. 
  *
  * @param {string} style The string representation of one or more inline CSS styles to include.
  */
  ...
  /**
  * Create instance of Subject bound with application bound under child documentElement. 
  *
  * @invariant Instance of Builder has not already been used to build a instance of Subject
